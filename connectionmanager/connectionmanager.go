...
func GetActiveConnections(w http.ResponseWriter, r *http.Request) {
	var con WebRTCConnection
	json.Unmarshal([]byte(jsonData), &con)


	fmt.Println("AAAA", con.Offer)

	// fmt.Fprintf(w, con.Offer.Sdp)
